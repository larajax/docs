...
[ajax:before-request](./events/index.md#ajax:before-request) | trigger | fired before the request is sent.
[ajax:before-send](./events/index.md#ajax-before-send) | window | fired before sending a request.
[ajax:request-start](./events/index.md#ajax:request-start) | window | fired when the HTTP request starts.
[ajax:request-end](./events/index.md#ajax:request-end) | window | fired when the HTTP request ends.
...
[ajax:request-complete](./events/index.md#ajax:request-complete) | trigger | fired after the request completes (success or error).
[ajax:request-cancel](./events/index.md#ajax:request-cancel) | trigger | fired when the request is cancelled (e.g., confirm declined).
[ajax:request-error](./events/index.md#ajax:request-error) | window | request encountered an error.
